...
{{- /* Build app context for value files helper */ -}}
{{- $appContext := merge $app (dict "chartName" $appName "releaseName" $appName) -}}
...
spec:
  ...
  source:
    ...
    helm:
      ...
      {{- end }}
  {{- end }}
  syncPolicy: {{ include "chart-library.syncPolicy" (dict "syncPolicy" $app.syncPolicy "defaults" $defaults) | nindent 4 }}
{{- end }}
{{- end }}
{{- end }}
{{- end }}
